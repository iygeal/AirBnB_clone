...
#         self.assertEqual(s, f.getvalue())
    ...
    def test_help_EOF(self):
        ...
        s = 'EOF command prints empty line, exits the program\n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_quit(self):
        ...
        s = 'Quit command which exits the program\n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_create(self):
        ...
        s = 'Creates a new obj, saves to JSON and prints the id\n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_show(self):
        ...
        s = 'Prints str rep of obj based on class name and id\n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_destroy(self):
        ...
        s = 'Deletes an instance based on name and ID, saves changes\n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_all(self):
        ...
        s = 'Prints string representations of all available objects\n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_count(self):
        ...
        s = 'Counts the number instances of a particular class\n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_update(self):
        ...
        s = 'Updates obj using class name and id, adding/updating attributes\n'
        self.assertEqual(s, f.getvalue())
